const experiences = [
  {
    ...
    description: 'Worked directly with the founding team on US Market Expansion, driving 100M+ views per month. Owned cross-functional initiatives spanning growth strategy, operations, finance, and go-to-market execution. Automated lead generation pipelines and managed departmental finances including international payments.',
